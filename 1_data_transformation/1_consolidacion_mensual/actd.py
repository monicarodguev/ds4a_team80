...
corto = np.array(['uso_inhal','ef_sueño','ef_act_usu','cont_asma','falta_aire'])
...
sueño = ['nunca','pocas veces','algunas veces','casi siempre','siempre']
...
base_p = base.pivot_table(index=['id','year','month'], columns='pregunta', dcc[modulo]['prefi']).reset_index()
